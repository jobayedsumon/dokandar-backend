    ...
    public function dboy_completed_order(Request $request)
     {
        ...
        $ord =DB::table('orders')
             ...
             ->groupBy('orders.order_status','orders.order_id','orders.ui_type','orders.cart_id','tbl_user.user_name', 'tbl_user.user_phone', 'orders.delivery_date', 'orders.total_price','orders.delivery_charge','orders.rem_price','orders.payment_status','delivery_boy.delivery_boy_name','delivery_boy.delivery_boy_phone','orders.time_slot', 'vendor.vendor_name','vendor.vendor_phone','vendor.lat','vendor.lng','user_address.lat', 'user_address.lng', 'delivery_boy.lat', 'delivery_boy.lng', 'user_address.user_number', 'user_address.houseno','user_address.state','user_address.street','user_address.pincode')
