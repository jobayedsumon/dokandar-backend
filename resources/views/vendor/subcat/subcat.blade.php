...
@section ('content')
        ...
        <div class="card shadow mb-4">
            <div class="card-header py-3">
                ...
                <form action="{{ route('searchsubcat') }}" method="post">
                    {{csrf_field()}}
                    <input type="text" value="" name="subcatname" class="form-control"
                           placeholder="Enter SubCategory Name" style="width: 20%; display: inline;">
                        ...
                        @if(count($subcat)>0)
                            ...
                            @foreach($subcat as $subcats)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('vendorEditsubcat',$subcats->subcat_id)}}"
                                           style="width: 28px; padding-left: 6px;" class="btn btn-info"
                                           style="width: 10px;padding-left: 9px;" style="color: #fff;"><i
                                                    class="fa fa-edit" style="width: 10px;"></i></a>
                                        <button type="button" style="width: 28px; padding-left: 6px;"
                                                class="btn btn-danger" data-toggle="modal"
                                                data-target="#exampleModal{{$subcats->subcat_id}}"><i
    ...
    @foreach($subcat as $subcats)
        <!-- Modal -->
        <div class="modal fade" id="exampleModal{{$subcats->subcat_id}}" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="{{route('vendordeletesubcat', $subcats->subcat_id)}}"
