         ...
         <!-- DataTales Example -->
              <div class="card shadow" style="width:100%">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">{{ __('Order_By_Photo')}}</h6>
                  @if (count($errors) > 0)
                              @if($errors->any())
               ...
               @if($lists->processed == 0)
                 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal1{{$lists->ord_id}}">{{ __('View_Accept')}}</button>
        	...
        	<div class="modal-dialog" role="document">
        		<div class="modal-content">
        			<div class="modal-header">
        				<h5 class="modal-title" id="exampleModalLabel"><b>{{ __('View_Accept')}}</b></h5>
