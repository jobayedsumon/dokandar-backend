...
(1, 'Dokandar', 'images/admin/profile/23-07-19/230719014721pm-activity.png', '9999999999', 'support@tecmanic.com', '$2y$10$.sOI9/OUKDrJOyNvFnecCO16nw89ekZ6TIC7.P2NHinRmrkTRpVIS');
...
(1229, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WGHL406c contains of Testing vendor id 1(1KG)*1 of price bdt 0 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-12 between 13:00-16:00.', 0, '2020-09-29 11:29:15', NULL),
(1230, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WGHL406c contains of Testing vendor id 1(1KG)*1 of price bdt 0 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-12 between 13:00-16:00.', 0, '2020-09-29 11:30:01', NULL),
(1231, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WGHL406c contains of Testing vendor id 1(1KG)*1 of price bdt 0 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-12 between 13:00-16:00.', 0, '2020-09-29 11:31:14', NULL),
(1232, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WGHL406c contains of Testing vendor id 1(1KG)*1 of price bdt 0 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-12 between 13:00-16:00.', 0, '2020-09-29 11:33:22', NULL),
(1233, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WMIL7184 contains of Testing vendor id 1(1KG)*1 of price bdt 101 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-10 between 13:00-16:00.', 0, '2020-09-29 11:37:42', NULL),
(1234, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WMIL7184 contains of Testing vendor id 1(1KG)*1 of price bdt 0 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-10 between 13:00-16:00.', 0, '2020-09-29 11:38:53', NULL),
(1235, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WMIL7184 contains of Testing vendor id 1(1KG)*1 of price bdt 0 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-10 between 13:00-16:00.', 0, '2020-09-29 11:46:15', NULL),
(1236, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WMIL7184 contains of Testing vendor id 1(1KG)*1 of price bdt 0 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-10 between 13:00-16:00.', 0, '2020-09-29 11:46:42', NULL),
(1237, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WMIL7184 contains of Testing vendor id 1(1KG)*1 of price bdt 0 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-10 between 13:00-16:00.', 0, '2020-09-29 11:50:50', NULL),
(1238, 421, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WMIL7184 contains of Testing vendor id 1(1KG)*1 of price bdt 101 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-10 between 13:00-16:00.', 0, '2020-09-29 11:52:50', NULL),
(1239, 472, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #OCAQ003f contains of Arhar Daal(1KG)*2 of price bdt 300 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-30 between 19:00 - 20:00.', 0, '2020-09-30 12:16:58', NULL),
(1240, 472, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #WWBG0942 contains of Arhar Daal(1KG)*2,Toor dal(1KG)*4,Moong Daal(1KG)*4,Turmeric Powder(200Grm)*3,Garam Masala(250Grm)*3 of price bdt 1460 is placed Successfully.You can expect your item(s) will be delivered on 2020-09-30 between 19:00 - 20:00.', 0, '2020-09-30 12:18:40', NULL),
(1241, 472, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #TPYX204e contains of Arhar Daal(1KG)*1,Toor dal(1KG)*3 of price bdt 470 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-01 between 11:00 - 12:00.', 0, '2020-09-30 16:09:26', NULL),
(1242, 472, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #CFRP97d9 contains of Arhar Daal(1KG)*3,Toor dal(1KG)*3,Moong Daal(1KG)*3 of price bdt 820 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-01 between 11:00 - 12:00.', 0, '2020-09-30 17:24:32', NULL),
...
(1350, 472, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #MSOI376b contains of Arhar Daal(1KG)*3 of price bdt 520 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-09 between 19:00 - 20:00.', 0, '2020-10-09 12:49:45', NULL),
(1351, 444, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #MQKH360f contains of Arhar Daal(1KG)*2,Toor dal(1KG)*2 of price bdt 550 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-11 between 10:00 - 11:00.', 0, '2020-10-09 15:27:45', NULL),
(1352, 444, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #KTKJ325d contains of Fish Oil(60Grm)*1 of price bdt 600 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-10 between 10:00 - 11:00.', 0, '2020-10-09 15:33:54', NULL),
...
(1356, 444, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #HTUG9982 contains of Toor dal(1KG)*2 of price bdt 300 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-10 between 11:00 - 12:00.', 0, '2020-10-09 16:06:24', NULL),
(1357, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #DCFS20b7 contains of Arhar Daal(1KG)*1,Toor dal(1KG)*1,Moong Daal(1KG)*1 of price bdt 390 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-10 between 12:00 - 13:00.', 0, '2020-10-10 04:55:17', NULL),
(1358, 444, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #XXBS46dd contains of Arhar Daal(1KG)*1,Toor dal(1KG)*1,Moong Daal(1KG)*1 of price bdt 390 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-11 between 10:00 - 11:00.', 0, '2020-10-10 05:53:27', NULL),
...
(1360, 536, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #DGFR914f contains of Arhar Daal(1KG)*2,Toor dal(1KG)*1,Toor dal(5KG)*1 of price bdt 850 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-14 between 10:00 - 11:00.', 0, '2020-10-12 23:39:08', NULL),
(1361, 536, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #LXCG798f contains of Panner Currey(small500 ml)*1 of price bdt 270 is placed Successfully.You can expect your item(s) will be delivered on 2020-10-16 between 13:00-16:00.', 0, '2020-10-20 10:36:29', NULL),
(1362, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #DBGZ33df contains of Pizza(4pices)*6 of price bdt 1000 is placed Successfully.You can expect your item(s) will be delivered on  between .', 0, '2020-11-12 11:54:22', NULL),
(1363, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #MCFZ0129 contains of Pizza(4pices)*6 of price bdt 1000 is placed Successfully.You can expect your item(s) will be delivered on  between .', 0, '2020-11-12 12:06:25', NULL);
INSERT INTO `user_notification` (`noti_id`, `user_id`, `noti_title`, `noti_message`, `read_by_user`, `created_at`, `image`) VALUES
(1364, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #BADC6671 contains of Pizza(4pices)*3 of price bdt 440 is placed Successfully.You can expect your item(s) will be delivered on  between .', 0, '2020-11-12 16:19:05', NULL),
(1365, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #XMYJ4405 contains of Arhar Daal(1KG)*6 of price bdt 940 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-13 between 15:00 - 16:00.', 0, '2020-11-13 08:25:47', NULL),
(1366, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #ZWXE019e contains of Arhar Daal(1KG)*7 of price bdt 1080 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-13 between 15:00 - 16:00.', 0, '2020-11-13 08:27:13', NULL),
(1367, 536, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #VRUH0714 contains of Pizza(4pices)*1 of price bdt 160 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-16 between .', 0, '2020-11-16 13:36:33', NULL),
(1368, 536, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #UOAV591f contains of Hyderabadi Dum Biryani(250Full)*1 of price bdt 230 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-16 between .', 0, '2020-11-16 14:15:23', NULL),
(1369, 437, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #KZDF4950 contains of Arhar Daal(1KG)*1,Toor dal(500Grm)*1 of price bdt 280 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-17 between 10:00 - 11:00.', 0, '2020-11-16 15:48:32', NULL),
(1370, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #YGIT485a contains of Chicken Leg Pieces(250Full)*10 of price bdt 2100 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-18 between .', 0, '2020-11-18 15:32:35', NULL),
(1371, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #CIGL3847 contains of Chicken Leg Pieces(250Half)*4 of price bdt 500 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-19 between .', 0, '2020-11-19 06:21:41', NULL),
...
(1374, 536, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #FMVO5404 contains of sanitizer(1Lts)*1 of price bdt 150 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-24 between .', 0, '2020-11-24 07:16:45', NULL),
(1375, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #DXVO3369 contains of sanitizer(1Lts)*5 of price bdt 600 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-26 between .', 0, '2020-11-26 12:48:33', NULL),
(1376, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #MHRM30b3 contains of sanitizer(1Lts)*4 of price bdt 500 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-26 between .', 0, '2020-11-26 12:54:00', NULL),
...
(1379, 537, 'WooHoo! Your Order is Placed', 'Order Successfully Placed: Your order id #AJEM89f3 contains of sanitizer(1Lts)*4 of price bdt 500 is placed Successfully.You can expect your item(s) will be delivered on 2020-11-28 between .', 0, '2020-11-28 08:55:50', NULL),
